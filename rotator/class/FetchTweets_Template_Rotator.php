...
class FetchTweets_Template_Rotator extends FetchTweets_Template_Rotator_Base {
    ...
    /**
     * Indicates whether the output exists or not.
     * 
     * The resource handler (outside of this class) checks this value and if exists, it adds resources.
     * 
     * @since       1.0.5
     */
    ...
    public function getOutput( array $aTweets ) {
        ...
        // Store output element arguments in the resource translation array so that they will be parse on the script side.
        FetchTweets_Template_Rotator_Resource::$aElementArguments[ $this->_sIDAttribute ] = $this->_aArgs;
        ...
        private function _getTweets( array $aTweets, array $aArgs ) {
            ...
            private function _getHeading( array $aTweet, array $aArgs ) {
                ...
                private function _getUserName( $aTweet, $aArgs ) {
                    ...
                    if ( ! $aArgs['visibilities']['user_name'] ) { 
                        return ''; 
                    }
            ...
            private function _getIntentButtons( array $aTweet, array $aArgs ) {
                ...
                if ( ! $aArgs['visibilities']['intent_buttons'] ) { 
                    return ''; 
                }
                $_aOutput= array();
