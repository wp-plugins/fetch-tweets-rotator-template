...
class FetchTweets_Template_Settings_Rotator extends FetchTweets_Template_Settings {
     ...
     * */
   /**
    * The page slug of the setting page.
    * @remark       in the url, the ... part of ?page=... 
    */
    protected $sParentPageSlug  = 'fetch_tweets_templates';    
    
    /**
     * The in-page tab slug of the setting page.
     * 
     * @remark      in the url, the ... part of &tab=...
     */
    protected $sParentTabSlug   = 'rotator';  
    
    /**
     * The template name
     */
    protected $sTemplateName    = 'Rotator';   
